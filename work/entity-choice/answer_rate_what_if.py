...
МЕХАНИЗМЫ = [("вето по синонимам", "unsupported_pick"),
             ...
             # ASK_SLOT_COVER по умолчанию выкл. Пометка появится в следе, когда
             # флаг включат для замера доли ответов; до того механизм молчит.
             ("слот величины (выкл.)", "slot_uncovered")]
