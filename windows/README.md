...
- **Состав OData: 3645 объектов / 4585 сущностей** (справочники, документы, 212 регистров накопления,
  1402 регистра сведений, 2 бухгалтерии, план счетов, перечисления) — задан `setup-1c-odata.exe --scope analytics`.
  ⚠ Права действуют поверх состава: под read-only профилем часть подсистемных регистров отдаёт «Доступ запрещен».
