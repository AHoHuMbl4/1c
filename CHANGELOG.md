...
test_compose **86/0**, test_step4_guards **101/0**. md5 ask `3dd6f642`.
Золотой: невозможен — эмбеддер недоступен. Выкат okna + живые регрессии —
дописываются после restart `1c-serene-ask@postgres` на okna.
