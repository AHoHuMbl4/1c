...
|---|---|---|---|---|
| эмбеддер 1024 | 5 (13 %) | 13 (34 %) | 17 (45 %) | 17 (45 %) |
| эмбеддер 4096 | 10 (26 %) | 17 (45 %) | 19 (50 %) | 19 (50 %) |
| **1024 + реранкер** | **14 (37 %)** | 19 (50 %) | 20 (53 %) | — |
...
3. 🔴 **Узкое место — первая ступень, а не реранкер.** Охват в первых 60 совпал с
   охватом в первой пятёрке (45 %): между 6-й и 60-й позицией верная сущность не
   появляется **ни разу**. Она либо близко, либо потеряна совсем, и расширять список
   кандидатов бессмысленно. Это и есть работа Э3.
