...
🔴 Выкат на фронт **не сделан**: правки на сервер в этой сессии закрыты
классификатором среды (ssh-запись, `rsync`, `scp` — отклонены). Команда для
выката — в `docs/DASHBOARD_GRAFANA.md` §4.
