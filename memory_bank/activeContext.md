...
Узкое место то же (LLM/гейт). Thinking=on — мусор в content. §9
[`LATENCY_AUDIT_2026-08-26.md`](../docs/LATENCY_AUDIT_2026-08-26.md).


🔴 **аудит латентности `[26.08]`** — код не трогали. Узкое место **не**
вектора (embed 0,04 с / отбор смысл ~0,3 с), а LLM + развилка: wall 16–29 с;
гейт/compose 4–10 с; cold intent ~10–20 с; clarify GAP 12–23 с вне шагов.
Док: [`LATENCY_AUDIT_2026-08-26.md`](../docs/LATENCY_AUDIT_2026-08-26.md).
