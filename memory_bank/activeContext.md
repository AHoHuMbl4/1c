...
_Обновлено: **2026-08-23.** Здесь — только живое: текущее состояние и «С ЧЕГО НАЧАТЬ».
...
🔴 **Ф5 IVF на боевой okna — собрано `[23.08]`**: SereneDB 26.08.1 `:7890`;
`resolver_ivf_idx` (69 621, 3,36 с, ~312 МБ) + `corpus_ivf_idx` (1,23M, 28,4 с,
~5,32 ГБ, peak ≈12,4 ГБ); metric=`ip` (нормы≈1); recall@10=**1.0**; lat exact
510 / IVF ~530 мс — не быстрее exact. `search_tables` IVF пропущен (254). Дальше
Ф6 (гибрид) / порог scorer ≥14/25 / переключение бота — оркестратор.
