...
🔴 **К2 compare финиш `[27.08]`**: P1–P5 (+дожим Q1/Q3/Q6) в ask; живой `:8094`
Q1–Q8 **8/8** (1049991.33 / −792128.74); замки **47/0**; AB_PROBE **8/8**.
Отчёт [`K2_COMPARE_TAIL.md`](../docs/K2_COMPARE_TAIL.md) §Результат. Бой `:8091`
ещё без выката.
