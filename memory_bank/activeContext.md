...
на уровне дашборда. Код `work/grafana-stand/setup-grafana-stand.sh`, дизайн и
открытые вопросы (размещение, авторизация) — `docs/DASHBOARD_GRAFANA.md`.
Выката нет. Следующий шаг: адаптер «ответ ask → панель» + OWUI Action.
