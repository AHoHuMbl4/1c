...
🔴 **граница данных витрины — замер готов `[21.08]`**:
[`docs/DATA_SCOPE_2026-08-21.md`](../docs/DATA_SCOPE_2026-08-21.md). На klient-1
class пуст (classify 401) → 5,5M адресных строк с векторами (27% витрины,
≈5,9 ч @260 стр/с). Граница class уже есть в коде; чинить auth/мягкий отказ
на первом такте — решение владельца. okna/klient не трогали.
