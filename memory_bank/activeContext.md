...
4. **И2** (главный замер): 67 вопросов двумя путями (:8091 движок, :18801 веб) — после векторов.
...
7. Секреты эмбедера: персистентные emb_postgres_0/1 созданы руками (/tmp/mk2sec.sh на окне);
   переживают рестарт; TEMPORARY из такта — нет. Знать при любом рестарте serenedb.
