...
- **`postgres_attach` читает живую PG, но поисковый индекс поверх неё НЕ строится** — DDL транслируется
  в btree внутри Postgres. «Данные в PG, поиск от Serene» — только чтение/агрегации, без индекса.
