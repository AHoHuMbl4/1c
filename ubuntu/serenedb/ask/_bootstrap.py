...
# B7/S1: legacy снесён; тракт один — всегда новый z20 (W2-A1 §S1).
_Z20_FILE = "z20_ask_main_http.py"
...
_ZONE_FILES = [
    ...
    # S1: три почти-мёртвые зоны снесены; щели — в z21/z15/z02 (+ headline → z11).
    "z10_rank.py",
    _zone_path(11, "sales"),
...
# S1/B7 (W2): патч прежнего z20 больше не нужен — identity.


def _patch_z20_wiki_primary(text: str) -> str:
    """Identity после сноса прежнего z20 (S1/B7; реестр W2-A1 + W2-R*)."""
    return text
