...
os.environ.setdefault("EMBED_BASE_URL", "http://embed.test:8000")
os.environ.setdefault("EMBED_HOST", "http://embed.test:8000")
...
# --- флаг 0: HTTP-путь ---
saved = with_env(ASK_EMBED_NATIVE="0")
http_hits = []
