...
# Ручного отбора сущностей БОЛЬШЕ НЕТ: состав определяет перепись, а не человек
# (`serene_sync.py`: «берём всё непустое и доступное»). Прежняя подсказка звала запустить
# `serene_select.py` и «отобрать бизнес-сущности» — это был главный ручной шаг установки
# и прямое нарушение п. 14 (ручных действий два, и оба в 1С/Windows).
echo "Данные: python3 serene_sync.py — состав определяется переписью базы, отбирать вручную нечего."
