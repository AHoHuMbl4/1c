...
Про п. 19: это разметка НА СБОРКЕ, разовая на сущность, с кэшем в базе. Повторно
спрашиваем только про НОВЫЕ сущности, поэтому объём, уходящий в модель, ограничен числом
