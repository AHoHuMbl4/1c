...
| Ollama + модель bge-m3 | офиц. скрипт ollama.com; **standby-эмбеддер**, в проде не используется (прод — DashScope) | `ollama` (11434) |
...
4. Ollama ставить (как в оригинале, standby) — предлагаю да.
