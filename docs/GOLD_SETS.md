...
| [`ubuntu/serenedb/client-gold-okna.tsv`](../ubuntu/serenedb/client-gold-okna.tsv) | **приёмка** (okna, эталоны 1С) | **48** | И0: dual-verify; **28.08** match **5** / freshness_lag **3** / mismatch **4** / pending **36**; с `1c` — **12** строк | `test_gold_sets_split` |
