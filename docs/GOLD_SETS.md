...
| [`ubuntu/serenedb/client-gold-okna.tsv`](../ubuntu/serenedb/client-gold-okna.tsv) | **приёмка** (okna, эталоны 1С) | **67** | И0 `work/gold/client_gold.py` packet↔vitrine; **29.08** live match **22** / needs_read **23** / pending **23** | `test_gold_sets_split` + `test_client_gold` |
